...
- `needs_review` indica falha; o erro público é genérico para não expor dados ou segredos. Não há repetição automática de extração paga após falha incerta. Trabalhos `processing` interrompidos por reinício permanecem assim para revisão operacional; não são reclamados automaticamente.

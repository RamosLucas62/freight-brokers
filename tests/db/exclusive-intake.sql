...
DO $$ DECLARE c public.audit_tms_connections; i integer; BEGIN
 ...
 UPDATE public.audit_tms_connections SET sync_enabled=true,sync_error='TMS_HTTP_503' WHERE tenant_id='97000000-0000-4000-8000-000000000001';
 ...
 INSERT INTO public.audit_tms_connections(tenant_id,provider,status,credentials_ciphertext,verified_at,sync_enabled)
 VALUES(c.tenant_id,'mcleod','verified','test',now(),true);
